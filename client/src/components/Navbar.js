          ...
          <ul className="navbar-nav mr-auto">
            <li className="nav-item active">
              <Link to="/" className="navItem btn">
                <span className="navItem"><img className="logo" src={logo} alt="logo img" height="30px" style={{padding:0}}/><span style={{fontWeight: 700}}> Discount</span>
                <span style={{fontWeight: 200}}>Monkey</span></span>
              </Link>
            </li>
